// 中文注释：锻炼模块种子数据，负责内置动作库分类。

part of 'workout.dart';

const defaultWorkoutActions = [
  WorkoutAction(
    name: '蝴蝶机夹胸',
    detail: '4组 × 8次 × 30kg',
  ...
  WorkoutAction(
      name: '哑铃侧平举',
      detail: '3组 × 15次 × 6kg',
      imageAsset: 'assets/workout/actions/shoulder_dumbbell_lateral_raise.png',
      icon: Icons.accessibility_new_rounded,
      groups: 3,
      status: '未开始',
      bodyPart: '肩颈',
  ...
  WorkoutAction(
      name: '站姿推举',
      detail: '3组 × 10次 × 20kg',
      imageAsset: 'assets/workout/actions/shoulder_standing_overhead_press.png',
      icon: Icons.sports_gymnastics_rounded,
      groups: 3,
      status: '未开始',
      bodyPart: '肩颈',
  ...
  WorkoutAction(
      name: '弹力带外旋',
      detail: '3组 × 15次',
      imageAsset: 'assets/workout/actions/shoulder_band_external_rotation.png',
      icon: Icons.sports_gymnastics_rounded,
      groups: 3,
      status: '未开始',
      bodyPart: '肩颈',
...
const defaultWorkoutBodyParts = ['全部', '胸背部', '肩颈', '核心', '腿臀', '有氧', '拉伸'];
